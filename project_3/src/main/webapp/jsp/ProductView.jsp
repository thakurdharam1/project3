					...
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5" id="productNameError">
									<%=ServletUtility.getErrorMessage("productName", request)%></font></br> <span
									class="pl-sm-5"><b>ProductAmmount</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="productAmmount"
					 						placeholder=" Enter productAmmount"
											oninput="handleIntegerInput(this, 'productAmmountError', 7)"
											onblur="validateIntegerInput(this, 'productAmmountError', 7)"
											value="<%=DataUtility.getStringData(dto.getProductAmmount()).equals("0") ? ""
					: DataUtility.getStringData(dto.getProductAmmount())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5" id="productAmmountError">
									<%=ServletUtility.getErrorMessage("productAmmount", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList1("productCategory", String.valueOf(dto.getProductCategory()), map)%>
									</div>
								</div>
