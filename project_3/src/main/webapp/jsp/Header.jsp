...
<style type="text/css">
.raj {
	background-image: linear-gradient(to bottom right, grey, aqua, black, grey, grey);
}
</style>
</head>
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Supplier</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.SUPPLIER_CTL%>"><i
							class="fas fa-calculator"></i>Add SupplierList</a> <a
							class="dropdown-item" href="<%=ORSView.SUPPLIER_LIST_CTL%>"> <i
							class="fas fa-sort-amount-down"></i>Supplier List
						</a>
					</div></li>
