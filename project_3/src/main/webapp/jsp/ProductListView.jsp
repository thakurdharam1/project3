				...
				<div class="col-sm-2">
					<input type="text" name="productAmmount"
						...
						value="<%=ServletUtility.getParameter("productAmmount", request)%>">
											<font color="red" class="pl-sm-5" id="productAmmountError"></font>
						
				</div>
				&emsp;
				<div class="col-sm-2">
					<%=HTMLUtility.getList1("productCategory", String.valueOf(map.get(dto.getProductCategory())),
						map)%>
				</div>
				&emsp;
				<div class="col-sm-2">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getPurchaseDate()%></td>
							<td class="text"><%=map.get(Integer.parseInt(dto.getProductCategory()))%></td>
