								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="name" placeholder="Enter Name"
											...
											onblur="validateLetterInput(this, 'nameError', 20)" rows="5"
											cols="5"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="paymentTerm"
											...
											value="<%=DataUtility.getStringData(dto.getPaymentTerm()).equals("0") ? ""
					: DataUtility.getStringData(dto.getPaymentTerm())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5" id="paymentTermError">
									<%=ServletUtility.getErrorMessage("paymentTerm", request)%></font></br> <span
									class="pl-sm-5"><b>Category</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="datepicker2" name="date"
											class="form-control" placeholder="Registration Date Enter"
